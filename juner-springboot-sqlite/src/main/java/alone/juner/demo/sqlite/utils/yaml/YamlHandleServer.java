 ...
 * @version 0.0.1
 * @description
 * @date 2022年07月01日 18:54 星期五
 * @since JDK_1.8.0.271
 */
public interface YamlHandleServer {
     ...
     * @throws IOException
     */
    default Map<String, Object> yamlHandler(@NonNull Resource resource) throws IOException {
        //返回的结果
     ...
     * @throws IOException
     */
    default Map<String, Object> yamlHandler(@NonNull Resource[] resources) throws IOException {
     ...
     * @param path
     */
    default void buildFlattenedMap(Map<String, Object> result, Map<String, Object> source, @Nullable String path) {
        //循环读取原数据
